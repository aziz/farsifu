...
# [:en]   English name
# [:fa]   Persian name
# rubocop:disable Layout/LineLength, Naming/ConstantName, Metrics/ModuleLength
module Iran
  # :stopdoc:
  Provinces = [
    ...
    { name: 'بوشهر', eng_name: 'Bushehr',                    capital: 'بوشهر',   eng_capital: 'Bushehr',     counties: %w(بوشهر تنگستان جم دشتستان دشتی دیر دیلم کنگان گناوه) },
    ...
    { name: 'چهارمحال و بختیاری', eng_name: 'Chahar Mahaal and Bakhtiari', capital: 'شهرکرد', eng_capital: 'Shahrekord', counties: %w(اردل بروجن شهرکرد فارسان کوهرنگ کیار لردگان) },
    { name: 'خراسان جنوبی', eng_name: 'Khorasan, South', capital: 'بیرجند', eng_capital: 'Birjand', counties: %w(بشرویه بیرجند درمیان سرایان سربیشه فردوس قائنات نهبندان) },
    ...
    { name: 'کردستان', eng_name: 'Kurdistan', capital: 'سنندج', eng_capital: 'Sanandaj', counties: %w(بانه بیجار دهگلان دیواندره سروآباد سقز سنندج قروه کامیاران مریوان) },
    ...
    { name: 'کهگیلویه و بویراحمد', eng_name: 'Kohgiluyeh and Boyer-Ahmad', capital: 'یاسوج',   eng_capital: 'Yasuj',       counties: %w(بویراحمد بهمئی دنا کهگیلویه گچساران) },
    ...
    { name: 'مرکزی', eng_name: 'Markazi', capital: 'اراک', eng_capital: 'Arak', counties: %w(آشتیان اراک تفرش خمین خنداب دلیجان زرندیه ساوه شازند کمیجان محلات) },
